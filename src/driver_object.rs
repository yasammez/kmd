...
pub type PDRIVER_INITIALIZE = Option<extern "fastcall" fn (_self: &mut DRIVER_OBJECT, &UNICODE_STRING) -> NTSTATUS>;
pub type PDRIVER_STARTIO = Option<extern "fastcall" fn (_self: &mut DRIVER_OBJECT, &IRP)>;
pub type PDRIVER_UNLOAD = Option<extern "fastcall" fn (_self: &mut DRIVER_OBJECT)>;
...
pub struct DRIVER_OBJECT
{
	pub Type: u16,
	pub Size: u16,
	pub DeviceObject: Option<NonNull<DEVICE_OBJECT>>,
	pub Flags: u32,
